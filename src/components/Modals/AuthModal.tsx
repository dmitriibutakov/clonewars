...
import {AuthInputKey, AuthModalInputs} from "../../utils/types/AuthModalTypes"
...
const AuthModal: React.FC<AuthModalProps> = () => {
    ...
    return (
        <>
            ...
            ></div>
            <div
                className="absolute left-[50%]  top-[50%] flex w-full translate-x-[-50%] translate-y-[-50%]  items-center justify-center sm:w-[450px]">
                <div className="relative mx-auto flex h-full w-full items-center justify-center">
                    <div
                        className="relative mx-6 w-full rounded-lg bg-white bg-gradient-to-b from-brand-orange to-slate-900 shadow">
