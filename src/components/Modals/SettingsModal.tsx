        ...
        <div className='text-white z-40'>
            <div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
                <div className='flex min-h-screen items-center justify-center px-4'>
                    ...
                    <div
                        className='my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-overlay-3 md:min-w-[420px] shadow-level4 shadow-lg p-0 bg-[rgb(40,40,40)] w-[600px] !overflow-visible opacity-100 scale-100'>
                        {/* setting header */}
                        <div
                            className='flex items-center border-b px-5 py-4 text-lg font-medium  border-dark-divider-border-2'>
                            Settings
                            <button
                                                ...
                                                {EDITOR_FONT_SIZES.map((fontSize, idx) => (
                                                    <SettingsListItem
                                                        ...
                                                        handleFontSizeChange={(fontSize) => {
                                                            ...
                                                            setSettings({...settings, fontSize, dropdownIsOpen: false});
                                                        }}
                                                    />
                                                ))}
                                            </ul>
