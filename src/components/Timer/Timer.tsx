...
const Timer: React.FC<TimerProps> = () => {
  ...
  return (
    <div className="relative mr-2 h-14 w-[100px]">
      <div className="absolute w-full right-0 top-[50%] translate-y-[-50%]">
        {showTimer ? (
          <div className="relative flex cursor-pointer items-center justify-start space-x-2 rounded bg-dark-fill-3 p-1 hover:bg-dark-fill-2">
          ...
          <div
            className="flex h-8 w-[30%] top-[50%] translate-y-[-50%] absolute right-0 cursor-pointer items-center rounded p-1 hover:bg-dark-fill-3"
